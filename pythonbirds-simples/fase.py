...
class Fase():
    ...
    def status(self):
        ...
        :return:
        """
        # somente a propria classe ou as subclasses terão acesso a estes metódos protegidos
    ...
    def _possui_porco_ativo(self):
        """Verifica se ainda há porcos ativos"""
    ...
    def _possui_passaro_ativo(self):
        """Verifica se ainda há passaros ativos"""
        for passaro in self._passaros:
